...
var SourceDividendData = "DividendData"
...
func (c *DividendDataCollector) Collect(ctx context.Context) (*CollectedBonds, error) {
	// TODO - get date from page
	collected := NewCollectedBonds(SourceDividendData, time.Now())
...
func (c *DividendDataCollector) readGilt(e *colly.HTMLElement) *CollectedBond {
